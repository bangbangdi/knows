                    ...
                    <div class="type">
                        <table width="100%" class="table">
                            ...
                            <c:forEach items="${lists}" var="items">
                                <tr>
                                    <td></td>
                                    <td style="align-content: center"><a href="${items.articleTypeName}"></a>
                                        <br/>
                                            ${items.articleTypeDesc}</td>
                                    <td>${items.countall}</td>
                                    <td><a href="${items.articleTypeName}"></a>
                                        <br/>${items.userName}<br/>${items.registerTime}
                                    </td>
                            ...
                            <%--<tr id="title_row_3"
                                ...
                                <td class="contentPart1"><img src="../static/images/topic_permit.gif"
                                    width="31" height="37" /></td>
                                <td class="contentPart2"><strong> <a
                                    cssClass="hong" action="articleAction_findArticlesByType"
                                    target="_blank">
                                    ${articleType.articleTypeName}
                                    <c:set value="${articleType.articleTypeName}"></c:set>
                                </a> </strong> (今日：<font style="COLOR: #ff0000">${articleType.articleCountOfToday}</font>)<br />
            ...
            <table width="95%" border="0" align="center" cellpadding="0"
                ...
                <tr>
                    ...
                    <td align="right" class="henhong">E-mail：mingrisoft@mingrisoft.com
                        ...
                        Copyright &nbsp;&copy;吉林省明日科技有限公司 1999-2009, All Rights Reserved
                    </td>
                </tr>
            </table>
        </td>
