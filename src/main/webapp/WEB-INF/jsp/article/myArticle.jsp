...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<c:forEach items="${lists}" var="item"></c:forEach>
				...
				<table width="100%" height="62" border="0" cellpadding="0"
					...
					<tr>
						...
						<div><a href="/known/public_html/question/thread-2"
							target="_blank"></a>${item.content} <%--<s:property value="#article.subContent" />--%></div>
						<div></div>
						</td>
					</tr>
					<tr>
						<td class="huise1"><span class="henhong">发表日期</span> ${item.emittime}<%--<s:date
							name="article.emitTime" format="yyyy-MM-dd hh:mm:ss" />--%>
						&nbsp;&nbsp;<a action="articleAction_querySingleArticle"
							cssClass="huise">查看详细>>${item.articleid}
						<%--<s:param name="article.articleId" value="#article.articleId"></s:param>--%>
						</a></td>
					</tr>
				</table>
	...
	<%@include file="/WEB-INF/jsp/pageUtil.jsp"%>
	<table width="100%" height="26" border="0" align="center"
		cellpadding="0" cellspacing="0">
		<tr>
