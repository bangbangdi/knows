...
<table width="100%" height="610%" border="0" cellpadding="0"
	cellspacing="0">
	<tr>
		<td height="28" valign="top" background="../static/images/loginbg.gif">
		<table width="676" height="284" border="0" align="center"
				...
				<table width="237" height="39" border="0" cellpadding="0"
					...
					<tr>
						<td align="right" bgcolor="#FFFFFF"><img
							src="../static/images/logo.gif" width="226" height="62" /></td>
					</tr>
				</table>
				</td>
			</tr>
			<tr>
				...
				<table id="__01" width="785" height="125" border="0" cellpadding="0"
					cellspacing="0">
					<tr>
						<td height="30"><img src="../static/images/login1_01.gif" width="785"
							height="30" alt="" /></td>
					</tr>
					<tr>
						<td height="18" background="../static/images/login1_02.gif">
						<table width="728" border="0" align="center" cellpadding="0"
							...
							<tr>
										...
										<table width="332" height="40" border="0" cellpadding="0"
											...
											<tr>
												<td align="center" valign="top"><img
													src="../static/images/btn_register.gif" width="302" height="36"
													onclick="register()" style="cursor: hand;" /></td>
											</tr>
										</table>
										</td>
									</tr>
								...
								<td width="367" align="left" valign="top"><img
									src="../static/images/zhuce.jpg" width="367" height="229" /></td>
							</tr>
						</table>
						</td>
					</tr>
					<tr>
						<td height="39"><img src="../static/images/login1_03.gif" width="785"
							height="39" alt="" /></td>
					</tr>
					<tr>
						<td height="38" background="../static/images/login1_04.gif">
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span
