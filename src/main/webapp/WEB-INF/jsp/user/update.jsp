...
<form action="updateUser" method="post"
	id="updateUserForm"><%--<s:hidden name="user.userId"></s:hidden>--%><%--<input type="text" name="userid" value="${userid}"/>--%>
										...
										<table width="350" height="40" border="0" cellpadding="0"
											...
											<tr>
												...
												<input name="username" type="text" size="30"
													id="username" value="${username}<%--<s:property value='user.userName'/>--%>" />
												<br />
											...
											<tr>
												...
												<input name="tel" type="text" size="30"
													value="${tel}<%--<s:property value='user.tel'/>--%>" /> <br />
												<span class="huise1">填写联系电话，方便联系你</span></td>
											</tr>
											<tr>
												<td width="350" valign="top">电子邮件：<br />
												<input name="email" type="text" size="30"
													value="${email}<%--<s:property value='user.email'/>--%>" /> <br />
