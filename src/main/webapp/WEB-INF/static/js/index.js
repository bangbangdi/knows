 ...
 */
function doSearch() {
	var bn=document.getElementById("articleTypeName").value;
	...
	//alert($('#articleTypeName').val(activeId))
	doSearchForm.submit();
	/*$('#articleTypeName').post("userAction/doSearch",data,function(
...
/*	$("btn").click(function () {
        $("#btn").post("userAction/doSearch",{'content':$.trim($('#searchStr').val()),'articleTypeName':$('#articleTypeName').val()},function (data) {
